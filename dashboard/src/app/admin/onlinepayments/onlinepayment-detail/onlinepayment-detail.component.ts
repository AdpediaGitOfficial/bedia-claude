...
@Component({
  selector: 'app-onlinepayment-detail',
  templateUrl: './onlinepayment-detail.component.html',
  styleUrls: ['./onlinepayment-detail.component.css']
})
export class OnlinepaymentDetailComponent implements OnInit {
  dislayDetails: any;
  id: string;
