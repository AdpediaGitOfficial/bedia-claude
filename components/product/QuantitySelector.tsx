 ...
 * Single Responsibility: Handle quantity selection and display total price
 * Single Responsibility: Only manages quantity, price calculation is separate concern
 */
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      {limit > 1 ? (
        ...
        <div>
          <Content className=" leading-relaxed">
            Kindly note: Please add one gift voucher at a time to your cart.
            Repeat the process if you'd like to purchase multiple vouchers.
          </Content>
        </div>
      )}
